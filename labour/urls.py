...
urlpatterns = [
    ...
    path('jcb/trips/add/', views.jcb_trip_create, name='jcb_trip_add'),
    path('jcb/trips/edit/<int:group_id>/', views.jcb_trip_edit, name='jcb_trip_edit'),
    ...
    path('holidays/add/<int:labour_id>/', views.holiday_create, name='holiday_add_for'),
    path('holidays/delete/<int:holiday_id>/', views.holiday_delete, name='holiday_delete'),
